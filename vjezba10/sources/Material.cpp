...
int Material::getWidth() { return this->width; }
int Material::getHeight() { return this->height; }
int Material::getChannels() {return this->nrChannels; }
unsigned char *Material::getData() { return this->data; }